...
CHAPTER_14 = (
    ...
    Problem("14.05", "Black to move. Can he draw?", "8/8/P7/3k4/1P6/1K5R/8/r7 b - - 0 43"),
    ...
    Problem("14.10", "White to move. Can he win?", "8/8/8/6Kp/kPp5/2P5/8/8 w - - 0 53"),
    Problem("14.11", "White to move. Can he win?", "r7/7R/8/8/8/8/1P2k3/1K6 w - - 0 1"),
    ...
    Problem("14.14", "Black to move. Larsen could not find a way to draw. Can you?", "6r1/8/8/8/4k1PK/R7/8/8 b - - 0 63"),
    ...
    Problem("14.17", "Black to move. According to ChessBase Magazine notes, this position is a dead draw, but with Black being an exchange and a pawn up that is difficult to believe, isn't it?", "8/8/3B4/5k2/6p1/1r3PK1/8/8 b - - 0 99"),
    Problem("14.18", "Black to move. Can he draw?", "6KR/8/pk6/8/8/8/8/8 b - - 0 1"),
    Problem("14.19", "White to move. What is the result?", "4k3/7R/8/3rP3/5K2/8/8/8 w - - 0 3"),
    Problem("14.20", "White to move. Can he draw?", "8/8/2p5/8/2P5/8/6K1/3k4 w - - 0 1"),
    Problem("14.21", "What is the result after 1.Kc6, 1.Kc4 or 1.Ke6?", "8/3r4/8/3K4/4P3/8/2k5/8 w - - 0 1"),
    Problem("14.22", "Black to move. Can he win?", "8/7p/8/3k2K1/6PP/8/2b5/8 b - - 0 54"),
    Problem("14.23", "Black to move. Can he win?", "8/6KP/4k3/8/5B2/7r/2p5/8 b - - 0 55"),
    Problem("14.24", "Black to move. Can he draw?", "b7/P1k5/6N1/8/5PK1/8/8/8 b - - 0 1"),
    Problem("14.25", "White to move. Can he win?", "8/5K1k/8/5p2/3b1P2/3B2P1/8/8 w - - 0 1"),
    Problem("14.26", "Find mistakes in the following moves: 90...Kh7 91.Qe4+ Kh8 92.Qc4 Kh7 93.Qf7+ Kh8 94.Qd7 Rg5 95.Qb7 Rg8 96.Qb3 Kh7 97.Kf7 Rg5 98.Qe6 Rg7+ 99.Kf8 Rg5 100.Qf6 Rg8+ 101.Kf7 Rg5 102.Qd4 Rf5+ 103.Ke6 Rg5 104.Kf6 Rg8 105.Qd7++-.", "6rk/8/5K1p/8/2Q5/8/8/8 b - - 0 90"),
    ...
    Problem("14.28", "Black is going to lose his rook. Can he draw after all?", "8/7P/5R1K/3kp3/8/8/8/6r1 b - - 0 63"),
    Problem("14.29", "White to move. Can he draw?", "8/8/2pr4/R7/8/1k6/4K3/8 w - - 0 69"),
    Problem("14.30", "Black to move. Can he draw?", "8/8/2k5/2P5/5KB1/6P1/8/3b4 b - - 0 89"),
    Problem("14.31", "White to move. What is the correct result?", "8/1n2k3/3n4/P7/7K/8/8/8 w - - 0 1"),
    Problem("14.32", "Black to move. What is the correct result?", "8/5p2/3k2p1/1Kp2pP1/2P2P2/8/8/8 b - - 0 50"),
    Problem("14.33", "Black to move. Can he win?", "4R3/8/8/5p2/6P1/7k/r7/6K1 b - - 0 1"),
...
SOURCE_TRANSCRIPTIONS: dict[str, str] = {
    ...
    "14.08": (
        "Moreno-Viñal, Pamplona op. 2005. It is drawn. 73.Ka6 Be3?? "
    ...
    "14.16": (
        ...
        "Ra7+ 5.Kg8 Kg6 6.h8N+ Kf6-+) 1...Ke4 2.h6 Ra1 3.Kg5 Ke5 4.Kg6 "
        "Ke6 5.Kg7!=."
    ),
    "14.17": (
        "Miladinovic-Beliavsky, Ohrid 2001. 99...gxf3? (99...Rxf3+! 100.Kg2 "
        "Rd3 101.Bc7 Kg5 with idea Kh4 and Rd2. 102.Be5 Rd5 103.Bc7 "
        "(103.Bg3 Rd2+; 103.Bh2 Rd2+ 104.Kg3 Ra2 105.Bg1 Ra3+ 106.Kg2 Kf4) "
        "103...Rd2+ 104.Kg3 Rd3+ 105.Kg2 Kh4!-+ and the white king is driven "
        "off his blockade position) 100.Bc5 Ke4 101.Kf2. Now the ending is a real "
    ...
    "14.19": (
        ...
        "6...Kf8 7.Ra8+-) 6.Rd7 Ra1 7.Ke7 Kg7 (7...Ra8 8.Rd8+!) 8.Ke8+! "
    ...
    "14.21": (
        ...
        "10.e8N+=) 2.e5 Kd3 3.Kf7 Rf4+ 4.Ke7 Ke4 5.e6 (5.Kd6 Kf5) 5...Ke5 "
        "6.Kd7 Rd4+-+ 0-1."
    ),
    "14.22": "54...Ke4! 55.Kh6 Kf4 56.g5 Bg6! 57.h5 Kf5-+ 0-1.",
    "14.23": (
        "Berkvens-Van Beek, Dieren 2000. Yes, 55...Rg3+!! 56.Kh6 (56.Bxg3 "
        "c1Q 57.h8Q Qg5+ 58.Kh7 Kf7-+; 56.Kh8 Kf7-+; 56.Kf8 Rf3!-+) "
        "56...Kf7! 57.Bc1 (57.h8N+ Kf6 58.Kh7 Rg7+ 59.Kh6 Rg4-+) "
        "57...Rh3+ 0-1."
    ),
    "14.24": (
        "Domínguez-Bruzón, Havana 2005. 89...Kb6? (yes, 89...Be4! 90.Ne7 Kb7= "
    ...
    "14.25": (
        ...
        "of the black king. 77.g4!! (77.Bxf5+? would allow Black to reach known "
        "defensive set-ups. 77...Kh6 78.g4 (78.Bc2 Be3 79.Kf6 Bd2 80.Kf5 Kg7=) "
        "78...Bf6!= 79.Bc2 Bd8 80.Ke6 Kg7=) 77...Kh8?! (77...Kh6 is more "
    ...
    "14.26": (
        ...
        "97.Kf7 Rg5 98.Qe6 Rg7+ 99.Kf8 Rg5 100.Qf6 Rg8+ 101.Kf7 Rg5 102.Qd4 "
        "Rf5+ 103.Ke6 Rg5 104.Kf6?? (104.Kf7 Rf5+ 105.Ke7 Rg5 106.Qe4+ Kh8 "
        "107.Qe6+-) 104...Rg8?? (104...Rg7=) 105.Qd7+?? (105.Ke7 or 105.Kf7+-) "
    ...
    "14.27": (
        ...
        "(81...Be7 82.Bf2 Kxg6 83.Bc5+-) 82.b4 Kf5 83.Kd5 Kf4 84.b5 Ke3 "
        ...
        "Kf5 83.Kd5 Kg4 84.b5 Kf3 85.Kc6 Ke4 86.Be1 Kd3 87.Kb7! Kc4 88.Ka6) "
        "81...Kxg6 82.b4 Kf5 83.Kd5 Here Janovsky resigned. 83...Kf4 84.Bd4 "
    ...
    "14.28": (
        ...
        "65...Kd3? 66.Rd8+! Kc3 (66...Ke3 67.h8Q Rxh8 68.Rxh8 e4 69.Kf5+-) "
        "67.h8Q Rxh8 68.Rxh8 e4 69.Re8 Kd3 70.Kf5 e3 71.Kf4 e2 72.Kf3+-) "
        "66.Kxh7 Kd3! 67.Rd8+ Ke3! (67...Kc3 68.Re8 Kd4 69.Kg6+-) 68.Kg6 e4 "
        "69.Kf5 Kf3! 70.Rh8 e3 71.Rh3+ Kf2 72.Kf4 e2 73.Rh2+ Kf1 74.Kf3 "
        "e1N+= The game should be drawn, but the rest appears in the appendix to "
    ...
    "14.30": (
        ...
        "89...Bb3? Here the bishop will not be able to reach the c8-h3 diagonal. "
        "(89...Ba4! 90.Bf3+ Kxc5 91.g4 (91.Ke5 Bd7! 92.Be4 Bg4! 93.Kf4 Bd7 "
        ...
        "97.Kf6 Kf4=) 90.Bf3+ Kxc5 91.Ke5!+- Bf7 92.g4 Bg6 (92...Kc4 93.g5 "
    ...
    "14.29": (
        ...
        "(69.Ra6? Kc3!Z 70.Rb6 (70.Ke1 Kb4-+ 71.Ke2 Kb5 72.Ra1 c5-+; "
