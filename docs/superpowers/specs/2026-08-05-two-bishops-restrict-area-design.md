...
The phrase "but not checking the king" applies to both stages. The rule uses current-board attacks only and is therefore translation-, rotation-, and reflection-invariant.
...
- Cover translations and every D4 transform.
