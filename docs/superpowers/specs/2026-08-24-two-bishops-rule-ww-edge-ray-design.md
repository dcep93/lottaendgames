...
> **rule ww** — Phase 2: If you don't already control the edge square 1 beyond the corner from Black's king, bishop control the edge square 2 beyond the corner from Black's king.
