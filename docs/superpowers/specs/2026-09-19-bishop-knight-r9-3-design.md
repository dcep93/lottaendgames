...
Rank resulting positions by maximum bishop Euclidean distance from Black. Knight distance does not contribute. Escaping beyond two steps retains credit. Earlier rules and r10 remain unchanged. Add the user's rule text and a timing/exemption note to the modal.
