...
> **rule g** — Of bishops on Black's side of all king moats, take the one furthest from White and move it furthest from the king moat on White's side.
...
3. Consider legal moves by those bishops whose destination is strictly on White's side of at least one recognized moat.
