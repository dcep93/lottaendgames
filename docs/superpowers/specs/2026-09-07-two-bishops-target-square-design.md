...
For `8/8/6B1/8/8/5K1k/3B4/8 w - - 0 1`, Bh5 counts five diagonals because White Kf3 screens d1–h5, even though Black cannot reach its hidden tail. Ke4 also counts five and has target f5 one king step away, so r10 uniquely prefers Ke4. The earlier guarded-tail test with White Kd2 and Bh6 now counts six instead of five. Verify both cases and the endpoint exception under all eight symmetries.
