...
For `8/6k1/3K4/8/8/7B/7B/8 w - - 0 1`, Ke5 reaches the closest target e5, two Black king steps away, and wins the r10 comparison. Ke6 has no target because White is inside the wall. Bg3 now wins overall under r10’s edge subpriority by moving the bishop off the corner edge before r10 compares targets.
