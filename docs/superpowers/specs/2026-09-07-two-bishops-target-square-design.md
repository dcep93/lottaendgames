...
The Bh6 count fix alone does not remove the Bg7/Kh4/Bh6/Kh5 loop: after r10 ties on six, r12 still prefers Bh6 over Bd3 and Ke3. Preserve this separate priority for a later user decision.
