...
Distance in this rule means row-plus-file distance. This distinguishes squares that king-move distance would collapse into a tie and does not measure the number of squares the Rook travels.
