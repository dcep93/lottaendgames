...
- **waiting move** — Move the rook as far as possible, keeping any existing box and ending closer to White's king than Black's.

“As far as possible” means the number of squares the Rook travels on this move.
...
5. Among moves satisfying those conditions, travel the maximum number of squares.
...
- Cover the closer-to-White geometry and maximum-travel tie-break directly.
