...
Rule T will require its forcing bishop move to finish strictly on White's side of the king moat. A bishop ending on the moat or Black's side receives no Rule T credit. The existing moat-opposition forcing test remains unchanged.
...
“From behind the moat” describes the bishop's resulting square and means strictly on White's side.
