...
Reset two-bishops training to one Phase 1 policy with a fixed Training Wheels position and three White move preferences.
...
3. **rule r** — Prefer smaller squared Euclidean distance between the kings.
