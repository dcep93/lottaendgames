...
Away from a corner, when the bishops are already together, prefer a non-checking bishop wait that keeps them together and does not increase the number of bishops on the board edge.
