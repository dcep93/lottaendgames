...
test('precage king-distance metric measures steps to Black across D4', () => {
...
test('precage king-distance metric activates before White moves and does not reward disabling its condition', () => {
...
test('precage king-distance metric measures king step proximity in the loaded position across D4', () => {
...
test('precage king-distance metric activates for Nd3 with Bd5 even without bishop adjacency, across D4', () => {
...
test('precage king-distance metric ties equal king-step distances across D4', () => {
  for (const t of SQUARE_TRANSFORMS) {
