...
test('precage targets are shared by both same-color central bishop placements across D4', () => {
 for (const t of SQUARE_TRANSFORMS) {
  for (const source of ['8/8/4N1k1/3BK3/8/8/8/8 w - - 0 1','8/8/4N1k1/4K3/4B3/8/8/8 w - - 0 1']) {
