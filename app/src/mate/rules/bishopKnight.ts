...
const bishopKnightHelp: RuleHelp = {
  ...
  notes: [
    ...
    "r2.5 exact preferences: White Kd6, Bb3 and Nd3 against Black Kb5 prefers Kc7. White Kf7 or Kf8, Bb3 and Nd3 against Black Kd6 prefers Ke8, before its general bishop and king-target preferences. Include reflections; move counters do not matter. r1.5 remains higher priority.",
