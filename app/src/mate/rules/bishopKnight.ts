...
function scoreKnightAndBishopWhiteMoveCore(
  ...
  return {
    ...
    attackedBishopDefensePenalty: context.shouldEscapeBishop && !bishopKingDefended ? 1 : 0,
    get attackedBishopEscapeScore() {
      return context.shouldEscapeBishop && !bishopKingDefended && bishop && blackKing
  ...
  [
    ...
    },
    {
      ...
      subpriorities: [
        ...
        { compare: (first, second) => first.bishopTargetCornerDistanceScore - second.bishopTargetCornerDistanceScore },
        { rank: scores => {
...
const bishopKnightHelp: RuleHelp = {
  ...
  notes: [
    ...
    "For r9.1, check before White moves whether Black's king attacks the bishop, even if it is already defended. Prefer king defense after White moves; these defended outcomes tie. Otherwise maximize the bishop's Euclidean distance from Black. Knight defense alone does not satisfy king defense. For r9.2, the knight must be attacked before White moves, whether or not it is already defended. Prefer king defense after the move; bishop defense alone does not satisfy this preference.",
    ...
    "r2.5 exact preferences: White Ke7, Bb5 and Nd5 against Black Kb7 prefers Kd8. White Kc6, Ba4 and Nd5 against Black Ka6 prefers Kc5. White Kc6, Ba6 and Nd5 against Black Ka7 prefers Kb5. White Kd6, Bd7 and Nd3 against Black Ka5 prefers Kc5. With Bb3 and Nd3, White Kc7 against Black Ka5 prefers Kc6, and White Kc6 against Black Ka6 prefers Kc5. White Kd6, Bb3 and Nd3 against Black Kb5 prefers Kd5. White Kf7 or Kf8, Bb3 and Nd3 against Black Kd6 prefers Ke8, before its general bishop and king-target preferences. Include reflections; move counters do not matter. r1.5 remains higher priority.",
