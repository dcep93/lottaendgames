...
const bishopKnightHelp: RuleHelp = {
  ...
  notes: [
    ...
    "For r9.9, minimize White’s king Euclidean distance to the board’s midpoint, then prefer its square to be opposite the bishop’s color. For r20, maximize the sum of the bishop’s and knight’s Euclidean distances from Black’s king. Evaluate after White moves.",
