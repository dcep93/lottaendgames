...
const bishopKnightHelp: RuleHelp = {
  ...
  notes: [
    "Declared five-diagonal support after Bc6: White Kd5, Bc6 and Nd3 against Black Ka5. Include reflections; move counters do not matter. The strict Nd3 king-side and bishop-placement requirements still apply.",
