...
const bishopKnightHelp: RuleHelp = {
  ...
  notes: [
    ...
    "Exact placement exception: White Kd6, Ba4 and Nd3 against Black Kb7 is a supported five-diagonal. Include reflections; move counters do not matter.",
    ...
    "r2.5 exact preference: White Kf7 or Kf8, Bb3 and Nd3 against Black Kd6 prefers Ke8, before its general bishop and king-target preferences. Include reflections; move counters do not matter. r1.5 remains higher priority.",
