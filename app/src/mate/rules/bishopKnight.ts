...
const bishopKnightHelp: RuleHelp = {
  ...
  notes: [
    ...
    "A five-diagonal is unsupported when the kings are more than two king steps apart after White moves. This requirement also applies to declared five-diagonal support exceptions.",
