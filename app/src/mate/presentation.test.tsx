...
test('priority guide follows registered facade order and renders typed diagrams', () => {
  ...
  assert.ok(decodedMarkup.includes("rule r9.2</strong> — If a knight is attacked and undefended, prefer king defense; otherwise prefer a square Black cannot attack on its next move, then proximity to the center."))
